...
@register_tool('security_qa')
class SecurityQA(BaseTool):
    description = 'Network security knowledge reasoning service, input network security related questions, and return the answer from network security experts.'
    parameters = [{
        'name': 'prompt',
        'type': 'string',
        'description': 'Detailed description of the network security question',
        'required': True,
    }]
